...
export interface ERC721OnChainMetadataInterface extends utils.Interface {
  functions: {
...
export interface ERC721OnChainMetadata extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721OnChainMetadataInterface;
