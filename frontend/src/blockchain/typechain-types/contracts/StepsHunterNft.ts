...
export interface StepsHunterNftInterface extends utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "contractURI()": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "goalStatusStyleMap(uint8)": FunctionFragment;
    "goalStatusTitleMap(uint8)": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "mintNft(address,uint256,(uint8,uint256,uint256,uint256,uint256,uint256,uint256))": FunctionFragment;
    ...
    "updateNft(uint256,(uint8,uint256,uint256,uint256,uint256,uint256,uint256))": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "goalStatusStyleMap",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "goalStatusTitleMap",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, NftMetadataCreateParamsStruct]
  ): string;
...
export interface StepsHunterNft extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StepsHunterNftInterface;
  ...
  functions: {
    ...
    mintNft(
      to: PromiseOrValue<string>,
      tokenId: PromiseOrValue<BigNumberish>,
      nftMetadata: NftMetadataCreateParamsStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
